...
export const TimerCheckSvg = ({ size, cls, thickness }: SvgProps) => {
  return (
   <svg className={cls} fill="currentColor" width={size} height={size}  viewBox="0 0 24 24" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg">
...
M11,7v4.586L8.293,14.293a1,1,0,1,0,1.414,1.414l3-3A1,1,0,0,0,13,12V7a1,1,0,0,0-2,0Z"/></svg>
  );
};
